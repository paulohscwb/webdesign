	...
	<p>Existem vários sites que mostram as escolhas de cores para usar em HTML. Vamos começar usando as cores com códigos HTML ou hexadecimais. Clique nos passos abaixo para ver como podemos escolher cores em 2 sites.</p>
	  <ul class="slider">
		  <li>
			   ...
			   <label for="slide002"><img src="basico/01_01_01.png" /></label>
		   ...
		   <li>
			   ...
			   <label for="slide003"></label><img src="basico/01_01_02.png"/></label>
		   ...
		   <li>
			   ...
			   <label for="slide004"><img src="basico/01_01_03.png"/></label>
		   ...
		   <li>
			   ...
			   <label for="slide001"><img src="basico/01_01_04.png" for="slide001" /></label>
